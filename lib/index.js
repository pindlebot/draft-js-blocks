...
var _leftIndent = _interopRequireDefault(require("left-indent"));
...
var indentForward = function indentForward(editorState) {
  ...
  var newContentState = selectedBlockMap.reduce(function (acc, val) {
    return _draftJs.Modifier.replaceText(acc, selectBlock(val), (0, _leftIndent.default)(val.getText(), 'forward', tabSize));
...
var indentBackward = function indentBackward(editorState) {
  ...
  var newText = (0, _leftIndent.default)(block.getText(), 'backward', tabSize);

  var newContentState = _draftJs.Modifier.replaceText(newEditorState.getCurrentContent(), selectBlock(block), newText);
