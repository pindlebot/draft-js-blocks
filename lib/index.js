...
exports.getBlocksAfterOfSameType = getBlocksAfterOfSameType;
exports.getBlocksBeforeOfSameType = getBlocksBeforeOfSameType;
...
function getBlocksAfterOfSameType(editorState, block) {
  var contentState = editorState.getCurrentContent();
  var blockMap = contentState.getBlockMap();
...
function getBlocksBeforeOfSameType(editorState, block) {
  var contentState = editorState.getCurrentContent();
  var blockMap = contentState.getBlockMap();
...
function getContiguousBlocks(editorState) {
  var block = getCurrentBlock(editorState);
  var blocksBefore = getBlocksBeforeOfSameType(editorState, block);
  var blocksAfter = getBlocksAfterOfSameType(editorState, block);
