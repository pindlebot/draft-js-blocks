...
var removeAllInlineStyles = function removeAllInlineStyles(editorState, style) {
  var currentContent = editorState.getCurrentContent();
  var selection = editorState.getSelection();
  var newContentState = currentContent.getBlockMap().reduce(function (acc, block) {
    var _acc = acc;
...
exports.removeAllInlineStyles = removeAllInlineStyles;