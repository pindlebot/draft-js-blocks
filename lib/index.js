...
exports.getSimilarBlocksBefore = getSimilarBlocksBefore;
exports.getSimilarBlocksAfter = getSimilarBlocksAfter;
exports.getBlockMapText = getBlockMapText;
exports.getSimilarContiguousBlocks = getSimilarContiguousBlocks;
exports.indentBackward = exports.indentForward = exports.selectBlock = exports.isCursorBetweenLink = exports.addNewBlockAt = exports.updateDataOfBlock = exports.resetBlockWithType = exports.addNewBlock = exports.getCurrentBlock = exports.getDefaultBlockData = exports.adjustBlockDepth = exports.insertText = void 0;
...
var indentForward = function indentForward(editorState) {
  ...
  var nextFocusOffset = endBlockSelection.getFocusOffset() + tabSize.length;
...
var indentBackward = function indentBackward(editorState) {
  ...
  var padding = (0, _leftIndent.getPadding)(text, 'backward', tabSize);
...
function getSimilarBlocksBefore(editorState, block) {
  var contentState = editorState.getCurrentContent();
  var blockMap = contentState.getBlockMap();
...
function getSimilarBlocksAfter(editorState, block) {
  var contentState = editorState.getCurrentContent();
  var blockMap = contentState.getBlockMap();
...
function getBlockMapText(blockMap) {
  return blockMap.reduce(function (acc, val) {
    return acc + val.getText() + '\n';
  }, '');
}

function getSimilarContiguousBlocks(editorState) {
  var block = getCurrentBlock(editorState);
  var blocksBefore = getSimilarBlocksBefore(editorState, block);
  var blocksAfter = getSimilarBlocksAfter(editorState, block);
